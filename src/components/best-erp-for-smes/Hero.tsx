    ...
    <section className="pt-8 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-6xl mx-auto px-6 py-8 md:py-10 text-center">
        <div className="inline-block bg-sky-800 text-white px-3 py-0.5 rounded-full text-sm font-semibold mb-2">
          Trusted ERP Partner for SMEs in Delhi NCR
        </div>
        ...
        <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
          Looking for the best ERP system for your small or medium business in Delhi?
          BizPlusERP helps SMEs manage inventory, accounting, GST billing, CRM,
          payroll, and daily operations in one powerful cloud-based business
          management platform designed for growing companies.
        </p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm text-slate-600">
          <div className="flex items-center gap-2">
            <span className="text-emerald-500 font-bold">✔</span> Inventory & Stock Management
          </div>
          <div className="flex items-center gap-2">
            <span className="text-emerald-500 font-bold">✔</span> GST Billing & Accounting Control
          </div>
          <div className="flex items-center gap-2">
            <span className="text-emerald-500 font-bold">✔</span> CRM & Business Automation for SMEs
          </div>
        </div>
      </div>
    </section>
